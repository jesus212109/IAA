...
La principal limitación de los ensambles es la pérdida de interpretabilidad y el mayor coste computacional, lo que condiciona su despliegue en entornos con recursos limitados. Para un sistema \textit{embedded} básico, un Árbol Simple o un Random Forest reducido (1-10 árboles) ofrecen el mejor compromiso entre precisión y eficiencia, sacrificando aproximadamente un 3.5\,\% de accuracy a cambio de inferencia ultrarrápida y consumo de memoria mínimo.
