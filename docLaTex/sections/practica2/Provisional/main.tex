\documentclass{report} % Usamos report porque la plantilla usa \chapter
\usepackage[utf8]{inputenc}
\usepackage[spanish]{babel}
\usepackage{graphicx} % Imprescindible para que cargue tus capturas
\usepackage{geometry}
...
\vspace{0.2cm}
\begin{center}
\includegraphics[width=0.90\linewidth]{data/k=2.png}
\end{center}
...
\vspace{0.2cm}
\begin{center}
\includegraphics[width=0.90\linewidth]{data/k=10.png}
\end{center}
...
\vspace{0.2cm}
\begin{center}
\includegraphics[width=0.90\linewidth]{data/k=100.png}
\end{center}
...
\vspace{0.2cm}
\begin{center}
\includegraphics[width=0.90\linewidth]{data/Ra=01.png}
\end{center}
\noindent RMSE Ridge ($\lambda=0.1$): \textbf{5.01}

\vspace{0.4cm}
\begin{center}
\includegraphics[width=0.90\linewidth]{data/Ra=10.png}
\end{center}
\noindent RMSE Ridge ($\lambda=10$): \textbf{5.96}

\vspace{0.4cm}
\begin{center}
\includegraphics[width=0.90\linewidth]{data/Ra=100.png}
\end{center}
...
\vspace{0.2cm}
\begin{center}
\includegraphics[width=0.90\linewidth]{data/La=01.png}
\end{center}
\noindent RMSE Lasso ($\lambda=0.1$): \textbf{5.00}

\vspace{0.4cm}
\begin{center}
\includegraphics[width=0.90\linewidth]{data/La=10.png}
\end{center}
\noindent RMSE Lasso ($\lambda=10$): \textbf{17.58}

\vspace{0.4cm}
\begin{center}
\includegraphics[width=0.90\linewidth]{data/La=100.png}
\end{center}
...
\subsection{El dilema de la complejidad — $\lambda$ demasiado alto}
...
\vspace{0.5cm}
\begin{center}
\includegraphics[width=0.90\linewidth]{data/Reto.png}
\end{center}
